...
namespace UCS_CRM.Migrations
{
    ...
    [Migration("20240725114838_added gender, account status and employee number to fintech member")]
    partial class addedgenderaccountstatusandemployeenumbertofintechmember
    {
        /// <inheritdoc />
