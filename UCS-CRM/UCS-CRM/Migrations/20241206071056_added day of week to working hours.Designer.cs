...
namespace UCS_CRM.Migrations
{
    ...
    [Migration("20241206071056_added day of week to working hours")]
    partial class addeddayofweektoworkinghours
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UCS_CRM.Core.Models.FailedRegistration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UCS_CRM.Core.Models.Holiday", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UCS_CRM.Core.Models.TicketPriority", b =>
                {
                    ...
                    b.Property<double>("MaximumResponseTimeHours")
            ...
            modelBuilder.Entity("UCS_CRM.Core.Models.WorkingHours", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UCS_CRM.Models.SystemDateConfiguration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("UseSystemTime")
                        .HasColumnType("tinyint(1)");

                    b.HasKey("Id");

                    b.ToTable("SystemDateConfigurations");
                });
            ...
            modelBuilder.Entity("UCS_CRM.Core.Models.ApplicationUser", b =>
                {
                    b.HasOne("UCS_CRM.Core.Models.Branch", "Branch")
                        .WithMany("Users")
            ...
            modelBuilder.Entity("UCS_CRM.Core.Models.MemberAccount", b =>
                {
                    ...
                    b.HasOne("UCS_CRM.Core.Models.Member", null)
            ...
            modelBuilder.Entity("UCS_CRM.Core.Models.Ticket", b =>
                {
                    ...
                    b.HasOne("UCS_CRM.Core.Models.Member", "InitiatorMember")
                        .WithMany()
                        .HasForeignKey("InitiatorMemberId");

                    b.HasOne("UCS_CRM.Core.Models.ApplicationUser", "InitiatorUser")
                        .WithMany()
            ...
            modelBuilder.Entity("UCS_CRM.Core.Models.TicketEscalation", b =>
                {
                    ...
                    b.HasOne("UCS_CRM.Core.Models.ApplicationUser", "EscalatedTo")
            ...
            modelBuilder.Entity("UCS_CRM.Core.Models.Ticket", b =>
                {
                    b.Navigation("StateTrackers");

                    b.Navigation("TicketAttachments");

                    b.Navigation("TicketComments");

                    b.Navigation("TicketEscalations");
                });
