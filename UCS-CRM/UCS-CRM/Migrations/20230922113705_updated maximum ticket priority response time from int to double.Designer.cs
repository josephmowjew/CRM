...
namespace UCS_CRM.Migrations
{
    ...
    [Migration("20230922113705_updated maximum ticket priority response time from int to double")]
    partial class updatedmaximumticketpriorityresponsetimefrominttodouble
    {
        /// <inheritdoc />
