...
namespace UCS_CRM.Areas.Manager.Controllers
{
    ...
    public class TicketEscalationsController : Controller
    {
        ...
        public TicketEscalationsController(ITicketEscalationRepository ticketEscalationRepository, IMapper mapper, IUnitOfWork unitOfWork)
        {
        ...
        [HttpPost]
        public async Task<ActionResult> GetTicketEscalations()
        {
            ...
            try
            {
                ...
                List<TicketEscalation>? repoTicketEscalations = await this._ticketEscalationRepository.GetTicketEscalations(CursorParameters);
